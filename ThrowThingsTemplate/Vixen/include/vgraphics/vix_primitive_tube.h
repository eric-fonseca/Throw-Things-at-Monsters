...
namespace Vixen {
	...
	class VIX_API PrimitiveTube
	{
	public:
		PrimitiveTube(float outRadius, float inRadius, float height, float subdivisions, Color c);
	...
	private:
		...
		std::vector<VertexPositionColor> m_outBodyVerts;
		std::vector<VertexPositionColor> m_inBodyVerts;
