...
namespace Vixen {
	...
	PrimitiveTube::PrimitiveTube(float outRadius, float inRadius, float height, float subdivisions, Color c)
	{
		m_rotationX = 0.0f;
		m_rotationY = 0.0f;
		m_rotationZ = 0.0f;
	...
	void PrimitiveTube::init_color_vi_buffers()
	{
		...
		{
			m_topVerts.push_back(VertexPositionColor(ri*cos(i), h, ri*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
			m_topVerts.push_back(VertexPositionColor(ro*cos(i), h, ro*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
		}

		m_topVerts.push_back(VertexPositionColor(ri, h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
		m_topVerts.push_back(VertexPositionColor(ro, h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
		...
		for(float i = 0; i <= TWO_PI; i += a)
		{
			m_botVerts.push_back(VertexPositionColor(ri*cos(i), -h, ri*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
			m_botVerts.push_back(VertexPositionColor(ro*cos(i), -h, ro*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
		}

		m_botVerts.push_back(VertexPositionColor(ri, -h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
		m_botVerts.push_back(VertexPositionColor(ro, -h, 0, 1.0f, 0.0f, 0.0f, 1.0f));

		//MIDDLE
		for(float i = 0; i <= TWO_PI; i += a)
		{
			m_inBodyVerts.push_back(VertexPositionColor(ri*cos(i), -h, ri*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
			m_inBodyVerts.push_back(VertexPositionColor(ri*cos(i), h, ri*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
		}

		m_inBodyVerts.push_back(VertexPositionColor(ri, -h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
		m_inBodyVerts.push_back(VertexPositionColor(ri, h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
	
		for(float i = 0; i <= TWO_PI; i += a)
		{
			m_outBodyVerts.push_back(VertexPositionColor(ro*cos(i), -h, ro*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
			m_outBodyVerts.push_back(VertexPositionColor(ro*cos(i), h, ro*sin(i), 1.0f, 0.0f, 0.0f, 1.0f));
		}

		m_outBodyVerts.push_back(VertexPositionColor(ro, -h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
		m_outBodyVerts.push_back(VertexPositionColor(ro, h, 0, 1.0f, 0.0f, 0.0f, 1.0f));
	}
	...
	void PrimitiveTube::Render(GLCamera3D* camera)
	{
		...
		VertexPositionColor::RenderArrays(m_topVerts.size(), GL_QUAD_STRIP);
		...
		m_vBuffer->bind();
		VertexPositionColor::Enable(true);
		VertexPositionColor::RenderArrays(m_botVerts.size(), GL_QUAD_STRIP);
		VertexPositionColor::Enable(false);
		m_vBuffer->unbind();
		...
		m_vBuffer->bind();
		VertexPositionColor::Enable(true);
		VertexPositionColor::RenderArrays(m_inBodyVerts.size(), GL_QUAD_STRIP);
		VertexPositionColor::Enable(false);
		m_vBuffer->unbind();
		...
		m_vBuffer->bind();
		VertexPositionColor::Enable(true);
		VertexPositionColor::RenderArrays(m_outBodyVerts.size(), GL_QUAD_STRIP);
		VertexPositionColor::Enable(false);
		m_vBuffer->unbind();
